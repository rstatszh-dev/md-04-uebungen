...
Durchgeführt und publiziert durch das Statistische Amt Kanton Zürich. Die publizierten OGD sind auf folgendem Link abrufbar: <https://www.zh.ch/de/politik-staat/statistik-daten/datenkatalog.html#/datasets/1341@statistisches-amt-kanton-zuerich>
...
befragung_fct <- befragung |>
    ...
    mutate(gemeinde_groesse = factor(gemeinde_groesse, levels = gemeinde_groesse_level))
```


```{r}
befragung_antwort_sum <- befragung_fct |> 
...
```{r}
ggplot(data = befragung_antwort_sum,
