...
1. Den Link zur CSV Datei im Objekt `github_link` speichern.
...
5. Link <https://github.com/openZH/covid_19/blob/master/fallzahlen_kanton_total_csv_v2/COVID19_Fallzahlen_Kanton_ZH_total.csv>
